 ...
 *
 * <p>{@code BatchAlreadyAnchored} 는 여기로 오지 않는다 — 그건 "이미 성공" 이라 {@link AnchorResult} 로 돌아간다.
 * 여기 오는 건 {@code RootMismatch} · {@code EmptyRoot} · {@code EmptyCommitCount} · {@code InvalidBatchId} ·
