...
/**
 * 디코딩된 {@code Anchored(bytes32 indexed merkleRoot, bytes32[] commitHashes)} 로그 한 건 (ANT-CHAIN-04 · v3 ANT-CHAIN-13).
 *
 ...
 * @param merkleRoot      0x + 64 hex, 소문자 — 체인 칸의 키이자 anchor_batches.merkle_root 와 맞추는 키
