 ...
 *
 * <p>{@code overCost} 는 슬롯 초과 시 소각할 ANT 금액(정수 문자열). 서버 금액표 {@code app.token.amounts.slot-over}(ANT-TOKEN-08)에서 온다.
 * ANT 는 decimals 0 이라(ANT-CHAIN-03) {@code "1000"} 이 곧 1,000 ANT 다. 숫자가 아니라 문자열인 이유는 다른 금액 필드
