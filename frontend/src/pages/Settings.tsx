    ...
    <main className="main">
      <div className="main-inner">
        ...
        {/* ── 내 채널 ───────────────────────────────────
            ...
            GET·PUT /me/channel/fee 가 아직 없어 지금은 잠긴 카드다. API 가 열리면
            현재 구독료 · 변경 이력 · 변경 폼이 이 자리에 들어간다. 그때 지켜야 할 것:
            - 가격 변경은 차기 주기부터다. 기존 구독자는 만료까지 옛 가격이라는 걸 명시한다.
            - 변경하면 구독자 전원에게 FEE_CHANGED 알림이 나간다. 되돌리기 어려우니 확인 단계를 둔다.
            - 변경 이력을 함께 보여준다. 이력 자체가 잦은 인상을 억제한다. */}
        <section className="st-block">
          <h2>내 채널</h2>
          <LockedCard label="채널 설정" title="구독료 설정은 준비 중입니다">
            <p className="st-pending-note">
              구독료를 정하고 변경 이력을 확인할 수 있게 됩니다.
              변경한 가격은 차기 주기부터 적용되고, 기존 구독자는 만료까지 옛 가격입니다.
            </p>
          </LockedCard>
        </section>
