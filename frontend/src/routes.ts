...
export const ROUTES: PageMeta[] = [
  ...
  { screen: 'C-03', element: PredictDetail, path: '/predictions/:id', title: '예측 상세', access: 'user', mode: 'insight', nav: 'portfolio', bodyClass: 'prediction-detail-page', story: 'ANT-FE-PREDICT-DETAIL' },
