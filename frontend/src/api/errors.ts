...
export const ERROR_CODE = {
  ...
  // 모의투자 (ANT-SEASON-03 · 04, API v0.36~v0.39)
  SEASON_NOT_FOUND: 'SEASON_NOT_FOUND',
  SEASON_TICKER_NOT_FOUND: 'SEASON_TICKER_NOT_FOUND',
  SEASON_ALREADY_JOINED: 'SEASON_ALREADY_JOINED',
  SEASON_NOT_RUNNING: 'SEASON_NOT_RUNNING',
  SEASON_JOIN_NOT_SUPPORTED: 'SEASON_JOIN_NOT_SUPPORTED',
  SEASON_NOT_JOINED: 'SEASON_NOT_JOINED',
  SEASON_INSUFFICIENT_QTY: 'SEASON_INSUFFICIENT_QTY',
  SEASON_PRICE_NOT_FOUND: 'SEASON_PRICE_NOT_FOUND',
  SEASON_ADVANCE_NOT_ALLOWED: 'SEASON_ADVANCE_NOT_ALLOWED',
  SEASON_ATTEMPT_ENDED: 'SEASON_ATTEMPT_ENDED',
